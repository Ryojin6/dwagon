  ...
  <TemplateDefault class="bg-r-charcoal font-sans">
    <AtomSection tp="large" bp="large">
      <AtomInner>
        <MoleculeTitle
          title="Vision Board"
          subtitle="Divided into separate seasons. 
          Each season has its own name, theme, and unique features. Each 
          season consists of 5 main objectives. Each season lasts around 150 days."
          tag="h1"
